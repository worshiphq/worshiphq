...
import { Fingerprint, Loader2, X, UserCheck } from "lucide-react";
  ...
  async function handleScan() {
    ...
    try {
      ...
      if (!options.allowCredentials?.length) {
        throw new Error("No fingerprints registered yet. Register members first from People page.");
      }
          ...
          <div className="text-center">
            {state === "scanning" && (
              <>
                ...
                <p className="mt-1 text-xs text-ink-faint">Use your laptop, phone, or USB scanner</p>
