...
export function BiometricRegisterButton({
  ...
  async function handleRegister() {
    setModalOpen(true);
    setState("scanning");
    setMessage("Requesting fingerprint scanner access...");
    ...
    try {
      ...
      const verifyRes = await fetch("/api/biometric/register-verify", {
        ...
        body: JSON.stringify({
          ...
          deviceName: navigator.userAgent.includes("Windows") ? "Windows device" : "Device",
        }),
      });
          ...
          <div className="text-center">
            {state === "scanning" && (
              <>
                ...
                <h3 className="mt-4 font-display text-lg font-bold">Fingerprint registration</h3>
